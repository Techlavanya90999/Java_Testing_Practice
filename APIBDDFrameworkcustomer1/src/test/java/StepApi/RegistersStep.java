...
public class RegistersStep extends BaseApi{
	Response response;
	...
	@Given("user add Register id path parameter")
	public void user_add_register_id_path_parameter(String registerId ) {
		httpRequest.pathParam("id", registerId);
